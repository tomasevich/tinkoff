...
describe('instrumentId as "6afa6f80-03a7-4d83-9cf0-c19d7d021f76"', () => {
  test('Expect "response" to have property "closePrices"', async () => {
    const response = await marketDataService.GetClosePrices({
      instruments: [{ instrumentId: '6afa6f80-03a7-4d83-9cf0-c19d7d021f76' }]
    })
    expect(response).toHaveProperty('closePrices')
  })
})
