...
describe('Запрашиваем списки инвестиционных фондов', () => {
  test('Получаем (весь) список инвестиционных фондов', async () => {
  ...
  test('Получаем (без указания статуса) список инвестиционных фондов', async () => {
    const response = await instrumentsService.Etfs({
  ...
  test('Получаем (базовый) список инвестиционных фондов', async () => {
    const response = await instrumentsService.Etfs({
  ...
  describe('Запрашиваем конкретный инвестиционный фонд', () => {
    ...
    test('Получаем инвестиционный фонд (указав фиги)', async () => {
      const response = await instrumentsService.EtfBy({
    ...
    test('Получаем инвестиционный фонд (указав тикер)', async () => {
      const response = await instrumentsService.EtfBy({
    ...
    test('Получаем инвестиционный фонд (указав айди)', async () => {
      const response = await instrumentsService.EtfBy({
    ...
    test('Получаем инвестиционный фонд (указав позицию)', async () => {
      const response = await instrumentsService.EtfBy({
